...
metadata {
	definition (name: "Xiaomi Aqara Temperature Humidity Sensor VID", namespace: "bspranger", author: "bspranger", mnmn: "SmartThings", vid: "SmartThings-smartthings-Xiaomi_Temperature_Humidity_Sensor", ocfDeviceType: "oic.d.thermostat") {
